...
import friendsforever.fyp.app.friendsforever.Model.GetLocationModel;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference=FirebaseDatabase.getInstance().getReference("User").child(mAuth.getUid()).child("Location");
